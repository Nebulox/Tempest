...
function ChargeFire:init()
  ...
  activeItem.setScriptedAnimationParameter("markerImage", "/items/active/weapons/ranged/abilities/ChargeFire/targetoverlay.png")
...
function ChargeFire:findTarget()
